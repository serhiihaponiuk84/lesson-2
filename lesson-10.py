...
def validation(pattern, expression):
...
# 4.
expression = ""
pattern = r"^([A-Za-zА-Яа-я]{2,20}\s){2}[A-Za-zА-Яа-я]{2,20}$"
...
print("5. Password (minimum: one capital letter, one small letter, one number, one symbol, password length -"
